...
mod tests {
    ...
    fn test_whole_file() {
        ...
        assert_eq!(hash, "e85655adf07244724785569c2180d8604c81dd6126a502dee002b6c7459322ba");
    }

    #[test]
    fn test_first_byte() {
        let hash = compute_hash("tests/assets/checksum.txt", 1).unwrap();
        assert_eq!(hash, "16dc368a89b428b2485484313ba67a3912ca03f2b2b42429174a4f8b3dc84e44");
    }

    #[test]
    fn test_no_bytes() {
        let hash = compute_hash("tests/assets/checksum.txt", 0).unwrap();
        assert_eq!(hash, "4a44dc15364204a80fe80e9039455cc1608281820fe2b24f1e5233ade6af1dd5");
    }
}
